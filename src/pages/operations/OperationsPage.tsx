    ...
    <>
      <div className="flex items-center justify-between rounded-[18px] bg-cream p-1">
        <div className="flex gap-2">
          <button className="rounded-[14px] bg-coffee px-4 py-2.5 text-sm font-semibold text-white">Sơ đồ phòng/bàn</button>
          <button className="rounded-[14px] px-4 py-2.5 text-sm font-semibold text-muted">Quản lý thực đơn</button>
        </div>
